  ...
  useEffect(() => {
    if (isOpen && article) {
      const fetchSummary = async () => {
        ...
        // Generate a new summary using real AI
        try {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold">AI Summary (Together.ai)</DialogTitle>
        </DialogHeader>
        <div className="py-4">
          ...
          <div className="mt-6 text-xs text-gray-500 italic">
            This summary was generated by Together.ai and may not capture all nuances of the article.
          </div>
        </div>
      </DialogContent>
    </Dialog>
